...
while True:
    ...
    #CREATE_LANDMARK
        ...
        test_landmark = "37.3599 -122.0098 : Sunnyvale is a nice place. : LandMarkName"
        request = json.dumps({"op":"CREATE_LANDMARK","username":"TEST_USER","uid":"TEST_UID","landmark":test_landmark})
    #FETCH_LANDMARKS
